...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@1,300&display=swap" id="main-font-link" />

  <link rel="stylesheet" href="{{ asset('theme/assets/fonts/tabler-icons.min.css')}}" />

  <link rel="stylesheet" href="{{ asset('theme/assets/fonts/material.css')}}" />

  <link rel="stylesheet" href="{{ asset('theme/default/css/style.css')}}" id="main-style-link" />
  <link rel="stylesheet" href="{{ asset('theme/default/css/style-preset.css')}}" id="preset-style-link" />
  <link href="{{ asset('idev/styles.css')}}" rel="stylesheet" />
</head>
...
<body>
  ...
  <header class="pc-header">
    <div class="m-header">
      LMS Sampharindo
      <div class="pc-h-item">
        <a href="#" class="pc-head-link head-link-secondary m-0 d-none" id="sidebar-hide">
  ...
  <script src="{{ asset('theme/assets/js/plugins/simplebar.min.js')}}"></script>
  <script src="{{ asset('theme/assets/js/plugins/bootstrap.min.js')}}"></script>
  <script src="{{ asset('theme/assets/js/plugins/sweet-alert.js')}}"></script>
  <script src="{{ asset('theme/assets/js/config.js')}}"></script>
  <script src="{{ asset('theme/assets/js/pcoded.js')}}"></script>
  <script src="{{ asset('idev/scripts.js')}}"></script>
