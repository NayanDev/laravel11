        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Rencana Awal',
                        data: [0, 0.2, 0.33, 0.32, 0.44, 0.56, 0.76],
                        borderWidth: 1,
                        borderColor: "#20c9e8",
                        backgroundColor: "#20c9e8",
                    },
                    {
                        label: 'Reschedule',
                        data: [0, 0.13, 0.23, 0.42, 0.56, 0.66, 0.96],
                        borderWidth: 1,
                        borderColor: "#f75474",
                        backgroundColor: "#f75474",
                    },
                    {
                        label: 'Actual',
                        data: [0, 0.08, 0.30, 0.31, 0.41, 0.50, 0.66],
                        borderWidth: 1,
                        borderColor: "#2dce89",
